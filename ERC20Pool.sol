...
// File: contracts/biz/ERC20Pool.sol
...
// Deposit ERC20 token, get Bmu
contract ERC20Pool is ERC20Wrapper, Auth {
    ...
    constructor(
        ...
        rewardRate = uint(166666e18).div(DURATION);
        periodFinish = starttime + DURATION;
    }

    modifier checkStart() {
        require(block.timestamp >= starttime, 'ERC20Pool: not start');
        _;
    }
    ...
    function setPeriodFinish(uint periodFinish_) public onlyOwner {
    ...
    checkStart
    {
        require(amount > 0, 'ERC20Pool: Cannot stake 0');
    ...
    checkStart
    {
        require(amount > 0, 'ERC20Pool: Cannot withdraw 0');
        require(deposits[msg.sender] >= amount, "ERC20Pool: balance is not enough");
